...
namespace CityInfo.API.Controllers
{
    ...
    public class PointsOfInterestController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<PointOfInterestDto>>> GetPointsOfInterest(int cityId)
        {
            ...
            var pointsOfInteretForCity = await _cityInfoRepository.GetPointsOfInterestForCityAsync(cityId);
            
            return Ok(_mapper.Map<IEnumerable<PointOfInterestDto>>(pointsOfInteretForCity));
        }
        ...
        public async Task<ActionResult> UpdatePointOfInterest(int cityId, int pointOfInterestId, PointOfInterestForUpdateDto pointOfInterest)
        {
            ...
            await _cityInfoRepository.UpdatePointOfInterestForCityAsync(pointOfInterestEntity);
        ...
        public async Task<ActionResult> DeletePointOfInterest(int cityId, int pointOfInterestId)
        {
            ...
            await _cityInfoRepository.DeletePointOfInterestAsync(pointOfInterestEntity);
